...
export default ExtendedFunctionVerticalLayout.extend({
    ...
    addInOut: function () {
        ...
        var labelSignature = new draw2d.shape.basic.Label({
            text: "Signature",
            stroke: 0,
            radius: 0,
            bgColor: null,
        ...
        var input2 = labelSignature.createPort("input");
        ...
        input2.setName("input_" + labelSignature.id);
        ...
        container.addRow(labelSignature);
    ...
    */
    onPortValueChanged: function (relatedPort) {
        ...
        this.getOutputPorts().setValue('Sv(' + data[0] + '){' + data[1] + '}');
    }
});